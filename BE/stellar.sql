...
CREATE TABLE [dbo].[learning_outcome] (
    ...
    CONSTRAINT [FK_learning_outcome_course_outline] FOREIGN KEY ([course_outline_id]) REFERENCES [dbo].[course_outline]([id]),
    PRIMARY KEY ([id])
);
...
INSERT INTO [dbo].[course_outline] ([id],[program_course_id],[academic_year],[pre_requisites],[co_requisites],[student_assessment],[passing_grade],[plar_method],[instructor_id],[prepared_by_user_id],[prepared_date],[approved_by_program_head_user_id],[approved_by_program_head_date],[approved_by_academic_chair_user_id],[approved_by_academic_chair_date],[program_head_approval],[academic_chair_approval]) VALUES (1,1,'2023-2024',NULL,NULL,'Assignments, exams','60%',NULL,1,1,'2023-08-15',2,NULL,3,NULL,'Approved','Pending'),(2,2,'2023-2024',NULL,NULL,'Case studies, presentations','70%',NULL,5,5,'2023-08-16',2,NULL,3,NULL,'Approved','Rejected'),(3,3,'2023-2024',NULL,NULL,'Lab reports, exams','65%',NULL,1,1,'2023-08-17',2,NULL,3,NULL,'Approved','Approved'),(4,4,'2023-2024','CS101',NULL,'Coding projects, assignments','60%',NULL,1,1,'2023-08-18',2,NULL,3,NULL,'Pending','Pending'),(5,5,'2023-2024','BA501',NULL,'Group projects, presentations','70%',NULL,5,5,'2023-08-19',2,NULL,3,NULL,'Rejected','Pending'),(6,1,'2024-2025','Math','Physics','Quizzes, Projects','50%','Portfolio',1,1,'2025-04-10',2,NULL,4,NULL,'Pending','Pending'),(7,2,'2024-2025','Test','Test','Test','50%','Portfolio',1,1,'2025-04-12',2,NULL,4,NULL,'Pending','Pending'),(8,1,'2024-2025','Math','Physics','Quizzes, Projects','50%','Portfolio',1,1,'2025-04-12',NULL,NULL,NULL,NULL,'Pending','Pending');
INSERT INTO [dbo].[degree] ([id],[name]) VALUES (1,'Diploma'),(2,'Post-Graduate Certificate'),(3,'Certificate'),(4,'Bachelor');
INSERT INTO [dbo].[learning_outcome] ([id],[outcome_text],[learning_activities],[course_outline_id]) VALUES (1,'Understand basic programming syntax','Lectures, coding exercises',1),(2,'Apply financial accounting principles','Case studies, problem-solving',2),(3,'Analyze electrical circuits','Lab experiments, simulations',3),(4,'Implement common data structures','Coding projects, assignments',4),(5,'Develop marketing strategies','Group projects, presentations',5),(6,'Demonstrate understanding of OOP concepts','Lecture, Labs',6),(7,'Use Git for version control','Workshops',1),(8,'Test','Test',7),(9,'Test','Test',7),(10,'Demonstrate understanding of OOP concepts','Lecture, Labs',8);
INSERT INTO [dbo].[learning_step] ([id],[learning_text],[learning_outcome_id]) VALUES (1,'Learn variables and data types',1),(2,'Understand control flow statements',1),(3,'Prepare financial statements',2),(4,'Calculate circuit parameters',3),(5,'Implement linked lists',4),(6,'Design a marketing campaign',5),(7,'Define class and object',6),(8,'Implement inheritance and polymorphism',6),(9,'Initialize Git repository',7),(10,'Commit and push changes',7),(11,'Test',8),(12,'Test',8),(13,'Test',9),(14,'Test',9),(15,'Define class and object',10),(16,'Implement inheritance and polymorphism',10);
